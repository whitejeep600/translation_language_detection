...
def main():
    ...
    if args.task_name is not None:
        ...
        #metric_arabic = evaluate.load("accuracy")
        #metric_chinese = evaluate.load("accuracy")
        #metric_indonesian = evaluate.load("accuracy")
        #metric_japanese = evaluate.load("accuracy")
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        logger.info(model.config.id2label)
        samples_seen = 0
        ...
        for step, batch in enumerate(eval_dataloader):
            ...
            for language in ['arabic','chinese','indonesian','japanese']:
                for i in range(len(predictions)):
                    if references[i]==model.config.label2id[language]:
                        predictions_for_all_languages[language].append(predictions[i])
            #model.config.label2id['arabic']
